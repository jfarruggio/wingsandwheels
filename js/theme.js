		...
		var Core = {
			...
			plugins : function(){
				...
				if($(pluginsCollection[5]).length){
					...
					newYear = new Date(newYear.getFullYear() + 1, -6, 6, 8, 0,0); 
					$(pluginsCollection[5]).countdown({
						until: newYear,
						layout:'<div class="row"><div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 m_xs_bottom_30">'+
						'<dl class="border_dark r_corners_2"><dt class="m_bottom_23">{d<}{dn}<hr class="divider_type_5"></dt><dd class="tt_uppercase color_black">{dl}</dd></dl></div> {d>}'+ 
	    					'<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 m_xs_bottom_30">'+
						'<dl class="border_dark r_corners_2"><dt class="m_bottom_23">{hn}<hr class="divider_type_5"></dt><dd class="tt_uppercase color_black">{hl}</dd></dl></div>'+
						' <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6"><dl class="border_dark r_corners_2"><dt class="m_bottom_23">{mn}<hr class="divider_type_5"></dt><dd class="tt_uppercase color_black">{ml}</dd></dl></div>'+
						' <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6"><dl class="border_dark r_corners_2"><dt class="m_bottom_23">{sn}<hr class="divider_type_5"></dt><dd class="tt_uppercase color_black">{sl}</dd></dl></div></div>'
					}); 
				}
